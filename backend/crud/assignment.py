...
def get_upcoming_assignments(db: Session, course_id: Optional[int] = None, limit: int = 10) -> List[Assignment]:
    """Get upcoming assignments, optionally filtered by course"""
...
def get_overdue_assignments(db: Session, course_id: Optional[int] = None) -> List[Assignment]:
    """Get overdue assignments, optionally filtered by course"""
    from datetime import datetime
